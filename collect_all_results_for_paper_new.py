...
gt_dir = '/media/ubuntu/SSD/refine_line_v1_512_512'

results_dir = [
    '/media/ubuntu/SSD/mmsegmentation/work_dirs/fcn_unet_s5-d16_256x256_40k_gd_line512new_lr0.01',
    '/media/ubuntu/SSD/mmsegmentation/work_dirs/deeplabv3_unet_s5-d16_256x256_40k_gd_line512new_lr0.01',
    '/media/ubuntu/SSD/mmsegmentation/work_dirs/pspnet_unet_s5-d16_256x256_40k_gd_line512new_lr0.01',
    '/media/ubuntu/SSD/VesselSeg-Pytorch/gd/gd_lineseg_new_Swin_Unet_bs=24_lr=0.1_tiny_224_4_',
    '/media/ubuntu/SSD/VesselSeg-Pytorch/gd/gd_lineseg_new_Swin_Unet_V2_bs=24_lr=0.2_tiny_224_4_',
]
...
for prefix in prefixes:
    ...
    if np.all(exists):
        ...
        H,W = im1.shape[:2]
        blank = np.ones((H, 5, 3), dtype=np.uint8)*255

        if subset == 'val':
            img = np.concatenate([im1[:,:,::-1], blank,im2, blank,im3, blank,im4, blank,im5, blank,im6,blank,im7], axis=1)
