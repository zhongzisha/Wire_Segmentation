...
SWIN_BACBONE=$7   # tiny,small,base
IMG_SIZE=$8    # 224
PATCH_SIZE=$9    # 4
...
CFG_FILE=swin_${SWIN_BACBONE}_patch4_window7_224_lite_v1_2.yaml
...
SAVE_DIR=gd_line_seg_${NETWORK}_bs=${BS}_lr=${LR}_${SWIN_BACBONE}_${IMG_SIZE}_${PATCH_SIZE}_${POSTFIX}
