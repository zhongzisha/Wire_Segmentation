...
GPU_ID=0      # 0 or 1
NETWORK=Swin_Unet     # U_Net or LadderNet
BS=24          # 4, 8, ...
LR=0.05          # 0.001 or ...
...
if [ ${HOSTNAME} == 'master2' ] || [ ${HOSTNAME} == 'slave' ]; then
LINE_REFINE_SEG_TMP_DIR=/media/ubuntu/SSD/VesselSeg-Pytorch/gd/RevisionV1
LINE_REFINE_SEG_DATA_ROOT=/media/ubuntu/SSD/refine_line_v1_512_512
