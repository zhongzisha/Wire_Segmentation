...
# ==================================================================
class U_Net_4layers_V1(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_4layers_V1, self).__init__()
...
# ==================================================================
class U_Net_4layers_V2(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_4layers_V2, self).__init__()
        ...
        self.Conv_1x1 = nn.Conv2d(32, output_ch, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0))
...
# ==================================================================
class U_Net_4layers_V3(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_4layers_V3, self).__init__()
        ...
        self.Conv_1x1 = nn.Conv2d(16, output_ch, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0))
...
# ==================================================================
class U_Net_4layers_V4(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_4layers_V4, self).__init__()
        ...
        self.Conv_1x1 = nn.Conv2d(8, output_ch, kernel_size=(1, 1), stride=(1, 1), padding=(0, 0))
...
# ==================================================================
class U_Net_2layers(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_2layers, self).__init__()
...
# ==================================================================
class U_Net_3layers(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(U_Net_3layers, self).__init__()
...
class Single_level_densenet(nn.Module):
    def __init__(self, filters, num_conv=4):
        ...
        for i in range(self.num_conv):
            self.conv_list.append(nn.Conv2d(filters, filters, kernel_size=(3, 3), padding=(1, 1)))
...
class Upsample_n_Concat(nn.Module):
    def __init__(self, filters):
        ...
        self.upsample_layer = nn.ConvTranspose2d(filters, filters, kernel_size=(4, 4), padding=(1, 1), stride=(2, 2))
        self.conv = nn.Conv2d(2 * filters, filters, kernel_size=(3, 3), padding=(1, 1))
...
class Dense_Unet(nn.Module):
    def __init__(self, in_chan=3, out_chan=2, filters=128, num_conv=4):
        ...
        self.outconv = nn.Conv2d(filters, out_chan, kernel_size=(1, 1))
